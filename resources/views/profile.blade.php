                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="mx-auto mb-2" style="width: 200px; height: 200px;">
                                @if (Storage::disk('public')->exists('qr/member-' . Auth::user()->member->id . '.png'))
                                    <img src="{{ asset('storage/qr/member-' . Auth::user()->member->id . '.png') }}"
                                        alt="QR Code" width="200">
                                @else
                                    {!! QrCode::size(200)->generate('MEMBER_ID:' . Auth::user()->member->id) !!}
                                @endif
                            </div>
                            <a href="{{ route('profile.qr.download') }}"
                                class="btn btn-sm btn-primary mb-4 w-50 mx-auto d-flex align-items-center justify-content-center">
